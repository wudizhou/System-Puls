        ...
        <div class="container">
                ...
                <ul class="actions">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dm-icon pull-right">
                            ...
                            <br/>
                            <li>
                                <nobr>&nbsp;&nbsp;<input type="text" name="" id="masthead-label-2"class="abc input-default" placeholder="请输入领料出库单编号" value="">&nbsp;<button style="height:26px; width:26px" onClick="puchaseWarehousing_del()" class="btn btn-default btn-icon"><i style="font-size:x-large" class="zmdi zmdi-delete"></i></button></nobr>
                            </li>
            ...
            <div class="card">
                ...
                <table id="data-table-command" class="table table-striped table-vmiddle">
                    <thead>
                    <tr>
                        <th data-column-id="purchaseStorageOrdersNo" data-type=""data-identifier="true">采购入库单编号</th>
                        <th data-column-id="commodityName"data-identifier="true">商品名称</th>
                        <th data-column-id="commodityStorageQuantity" data-order=""data-identifier="true">商品入库数量</th>
                        <th data-column-id="supplier" data-order=""data-identifier="true">供应商</th>
                        <th data-column-id="commodityStorageDate" data-order=""data-identifier="true">商品入库日期</th>
                        <th data-column-id="storageStaff" data-order=""data-identifier="true">仓储员工</th>
                        <th data-column-id="commodityCategory" data-order=""data-identifier="true">商品类别</th>
                        <th data-column-id="commodityStorageStatus" data-order=""data-identifier="true">商品入库状态</th>
                        <%--<th data-column-id="commands" data-formatter="commands" data-sortable="false"data-identifier="true"data-row-id="commands">操作权限</th>--%>
                    </tr>
                    </thead>
                    <tbody>
                    <c:forEach items="${PurchaseWarehousingList}" var="userList">
                        <tr>
                            <td><input  type="checkbox" name="id[]"
                                        value="${userList.purchaseStorageOrdersNo}" />${userList.purchaseStorageOrdersNo}</td>
                            <td>${userList.commodityName}</td>
                            <td>${userList.commodityStorageQuantity}</td>
                            <td>${userList.supplier}</td>
                            <td><fmt:formatDate value="${userList.commodityStorageDate}"
                                                pattern="yyyy-MM-dd HH:mm:ss" /></td>
                            <td>${userList.storageStaff}</td>
                            <td>${userList.commodityCategory}</td>
                            <td>${userList.commodityStorageStatus}</td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
                ...
                <div class="text-center">
                    <div class="card pt-inner">
                        <div class="pti-header bgm-bluegray">
                            <h2>采购入库单单修改</h2><small>| safe</small>
                ...
                <form id="add" class="form-horizontal">
                    <div class="form-group">
                        <nobr><label for="add" class="col-sm-2 control-label"><i style="font-size:xx-large"class="zmdi zmdi-assignment zmdi-hc-fw"></i></label>
                            <div class="col-sm-6">
                                <input type="hidden" id="purchaseStorageOrdersNo" name="purchaseStorageOrdersNo" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input style="font-size:x-large" type="name" name="commodityName" class="form-control" id="commodityName" placeholder="请输入商品名称">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input style="font-size:x-large" type="value" name="commodityCategory" class="form-control" id="commodityCategory" placeholder="请输入商品类别">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input style="font-size:x-large" type="" name="commodityStorageQuantity" class="form-control" id="commodityStorageQuantity" placeholder="请输入商品入库数量">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input style="font-size:x-large" type="value" name="storageStaff" class="form-control" id="storageStaff" placeholder="请输入仓储员工">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input style="font-size:x-large" type="value" name="commodityStorageDate" class="form-control" id="commodityStorageDate" placeholder="商品入库日期">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input style="font-size:x-large" type="name" name="supplier" class="form-control" id="supplier" placeholder="请输入供应商">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input style="font-size:x-large" type="" id="commodityStorageStatus"name="commodityStorageStatus" class="form-control" placeholder="请输商品入库状态">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="text-center">
                    <div class="card pt-inner">
                        <div class="pti-header bgm-bluegray">
                            <h2>采购入库单单增加</h2><small>| safe</small>
                            <div class="ptih-title">Banana Pack</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-body">
                <form id="" class="form-horizontal">
                    <div class="form-group">
                        <nobr><label for="add" class="col-sm-2 control-label"><i style="font-size:xx-large"class="zmdi zmdi-assignment zmdi-hc-fw"></i></label>
                            <div class="col-sm-6">
                                <input type="name"  style="font-size:x-large" name="purchaseStorageOrdersNo" class="form-control">
                                <span class="help-block"></span>
                            </div>
                        </nobr>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="add" class="col-sm-2 control-label"><i style="font-size:xx-large"class="zmdi zmdi-dialpad zmdi-hc-fw"></i></label>
                        <div class="col-sm-6">
                            <input style="font-size:x-large" type="value" name="commodityCategory" class="form-control" placeholder="请输入商品类别">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="add" class="col-sm-2 control-label"><i style="font-size:xx-large"class="zmdi zmdi-collection-item-1 zmdi-hc-fw"></i></label>
                        <div class="col-sm-8">
                            <input style="font-size:x-large" type="" name="commodityStorageQuantity" class="form-control"  placeholder="请输入商品入库数量">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="add" class="col-sm-2 control-label"><i style="font-size:xx-large"class="zmdi zmdi-account-circle zmdi-hc-fw"></i></label>
                        <div class="col-sm-6">
                            <input style="font-size:x-large" type="value" name="storageStaff" class="form-control"  placeholder="请输入仓储员工">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="add" class="col-sm-2 control-label"><i style="font-size:xx-large"class="zmdi zmdi-time zmdi-hc-fw"></i></label>
                        <div class="col-sm-6">
                            <input style="font-size:x-large" type="date" name="commodityStorageDate" class="form-control"  placeholder="商品入库日期">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="add" class="col-sm-2 control-label"><i style="font-size:xx-large"class="zmdi zmdi-redo zmdi-hc-fw"></i></label>
                        <div class="col-sm-8">
                            <input style="font-size:x-large" type="" name="commodityStorageStatus" class="form-control" placeholder="请输商品入库状态">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
...
//              });
    ...
    // }
    <!--删除单项-->
    function  puchaseWarehousing_del(){
        var id=document.getElementById("masthead-label-2").value
        var r = confirm("是否确认删除？");
        if(r==true){
            $.get("/purchaseWarehousingController/purchaseWarehousingDelete.do?purchaseStorageOrdersNo="+id,function(data){
                if(data=="ok"){
                    alert("删除失败！");
                }else{
                    alert("删除成功！");
    ...
    $('#update_button').click(function () {
        //1、判断员工的正则表示
        $.ajax({
            url:'<%=basePath%>/purchaseWarehousingController/savePurchaseWarehousing.do',
            type:"POST",
    ...
    function useAjaxUpdate() {
        ...
        $.ajax({
            url:'<%=basePath%>/purchaseWarehousingController/getPurchaseWarehousing.do',
            type: 'POST',
            dataType: "JSON",
            ...
            success:function (json){
                ...
                //  console.log(data);
                //得到emp的值
                var ptmData = json.ptm;
                // var dateOfSob = new Date(sobData.salesDate);
                $('#purchaseStorageOrdersNo').val(ptmData.purchaseStorageOrdersNo);
                $('#commodityName').val(ptmData.commodityName);
                $('#commodityCategory').val(ptmData.commodityCategory);
                $('#supplier').val(ptmData.supplier);
                $('#storageStaff').val(ptmData.storageStaff);
                $('#commodityStorageStatus').val(ptmData.commodityStorageStatus);
                $('#commodityStorageQuantity').val(ptmData.commodityStorageQuantity);
                $('#commodityStorageDate').val(ptmData.commodityStorageDate);
            }
        });
        $('#myUpdateModal').modal({
            backdrop : 'static'
    ...
    $('#update_button2').click(function () {
        $.ajax({
            url:'<%=basePath%>/purchaseWarehousingController/addPurchaseWarehousing.do',
            type:"POST",

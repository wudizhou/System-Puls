        ...
        <div class="container">
                ...
                <ul class="actions">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dm-icon pull-right">
                            ...
                            <br/>
                            <li>
                                <nobr>&nbsp;&nbsp;<input type="text" name="" id="masthead-label-2"class="abc input-default" placeholder="请输入领料出库单编号" value="">&nbsp;<button style="height:26px; width:26px" onClick="saleOutbound_del()" class="btn btn-default btn-icon"><i style="font-size:x-large" class="zmdi zmdi-delete"></i></button></nobr>
                            </li>
            ...
            <div class="card">
                ...
                <table id="data-table-command" class="table table-striped table-vmiddle">
                    <thead>
                    <tr>
                        <th data-column-id="saleOutboundDeliveryOrderNo" data-type=""data-identifier="true">销售出库单编号</th>
                        <th data-column-id="productName"data-identifier="true">产品名称</th>
                        <th data-column-id="customerName" data-order=""data-identifier="true">客户名称</th>
                        <th data-column-id="salesStaff" data-order=""data-identifier="true">销售员工</th>
                        <th data-column-id="productOutboundDeliveryDate" data-order=""data-identifier="true">产品出库日期</th>
                        <th data-column-id="productOutboundDeliveryQuantity" data-order=""data-identifier="true">产品出库数量</th>
                        <%--<th data-column-id="commands" data-formatter="commands" data-sortable="false"data-identifier="true"data-row-id="commands">操作权限</th>--%>
                    </tr>
                    </thead>
                    <tbody>
                    <c:forEach items="${SalesOutboundList}" var="userList">
                        <tr>
                            <td><input  type="checkbox" name="id[]"
                                        value="${userList.saleOutboundDeliveryOrderNo}" />${userList.saleOutboundDeliveryOrderNo}</td>
                            <td>${userList.productName}</td>
                            <td>${userList.customerName}</td>
                            <td>${userList.salesStaff}</td>
                            <td>${userList.productOutboundDeliveryDate}</td>
                            <td>${userList.productOutboundDeliveryQuantity}</td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
                ...
                <form id="add" class="form-horizontal">
                    <div class="form-group">
                        <nobr><label for="add" class="col-sm-2 control-label"><i style="font-size:xx-large"class="zmdi zmdi-assignment zmdi-hc-fw"></i></label>
                            <div class="col-sm-6">
                                <input type="hidden" id="saleOutboundDeliveryOrderNo" name="saleOutboundDeliveryOrderNo" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input style="font-size:x-large" type="" name="productOutboundDeliveryQuantity" class="form-control" id="productOutboundDeliveryQuantity" placeholder="请输入产品出库数量">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input style="font-size:x-large" type="value" name="customerName" class="form-control" id="customerName" placeholder="请输入客户名称">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input style="font-size:x-large" type="value" name="productOutboundDeliveryDate" class="form-control" id="productOutboundDeliveryDate" placeholder="商品入库日期">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input style="font-size:x-large" type="name" name="salesStaff" class="form-control" id="salesStaff" placeholder="销售员工">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-body">
                <form id="" class="form-horizontal">
                    <div class="form-group">
                        <nobr><label for="add" class="col-sm-2 control-label"><i style="font-size:xx-large"class="zmdi zmdi-assignment zmdi-hc-fw"></i></label>
                            <div class="col-sm-6">
                                <input type="name"  style="font-size:x-large" name="saleOutboundDeliveryOrderNo"placeholder="请输入产品名称" class="form-control">
                                <span class="help-block"></span>
                            </div>
                        </nobr>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="add" class="col-sm-2 control-label"><i style="font-size:xx-large"class="zmdi zmdi-collection-item-1 zmdi-hc-fw"></i></label>
                        <div class="col-sm-8">
                            <input style="font-size:x-large" type="" name="productOutboundDeliveryQuantity" class="form-control"  placeholder="请输入产品出库数量">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="add" class="col-sm-2 control-label"><i style="font-size:xx-large"class="zmdi zmdi-account-circle zmdi-hc-fw"></i></label>
                        <div class="col-sm-6">
                            <input style="font-size:x-large" type="value" name="customerName" class="form-control"  placeholder="请输入客户名称">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="add" class="col-sm-2 control-label"><i style="font-size:xx-large"class="zmdi zmdi-time zmdi-hc-fw"></i></label>
                        <div class="col-sm-6">
                            <input style="font-size:x-large" type="date" name="productOutboundDeliveryDate" class="form-control"  placeholder="商品入库日期">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="add" class="col-sm-2 control-label"><i style="font-size:xx-large"class="zmdi zmdi-account zmdi-hc-fw"></i></label>
                        <div class="col-sm-6">
                            <input style="font-size:x-large" type="name" name="salesStaff" class="form-control"  placeholder="销售员工">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
...
//              });
    ...
    <!--删除单项-->
    function  saleOutbound_del(){
        var id=document.getElementById("masthead-label-2").value
        var r = confirm("是否确认删除？");
        if(r==true){
            $.get("/salesOutboundController/salesOutboundDelete.do?saleOutboundDeliveryOrderNo="+id,function(data){
                if(data=="ok"){
                    alert("删除失败！");
                }else{
                    alert("删除成功！");
    ...
    $('#update_button').click(function () {
        //1、判断员工的正则表示
        $.ajax({
            url:'<%=basePath%>/salesOutboundController/saveSalesOutbound.do',
            type:"POST",
    ...
    function useAjaxUpdate() {
        ...
        $.ajax({
            url:'<%=basePath%>/salesOutboundController/getSalesOutbound.do',
            type: 'POST',
            dataType: "JSON",
            ...
            success:function (json){
                ...
                $('#saleOutboundDeliveryOrderNo').val(som.saleOutboundDeliveryOrderNo);
                $('#productName').val(som.productName);
                $('#customerName').val(som.customerName);
                $('#salesStaff').val(som.salesStaff);
                $('#productOutboundDeliveryQuantity').val(som.productOutboundDeliveryQuantity);
                $('#productOutboundDeliveryDate').val(som.productOutboundDeliveryDate);
            }
        });
        $('#myUpdateModal').modal({
            backdrop : 'static'
    ...
    $('#update_button2').click(function () {
        $.ajax({
            url:'<%=basePath%>/salesOutboundController/addSalesOutbound.do',
            type:"POST",

        ...
        <div class="container">
                ...
                <ul class="actions">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dm-icon pull-right">
                            ...
                            <br/>
                            <li>
                                <nobr>&nbsp;&nbsp;<input type="text" name="" id="masthead-label-2"class="abc input-default" placeholder="请输入领料出库单编号" value="">&nbsp;<button style="height:26px; width:26px" onClick="productWarehousing_del()" class="btn btn-default btn-icon"><i style="font-size:x-large" class="zmdi zmdi-delete"></i></button></nobr>
                            </li>
            ...
            <div class="card">
                ...
                <table id="data-table-command" class="table table-striped table-vmiddle">
                    <thead>
                    <tr>
                        <th data-column-id="productStorageOrdersNo" data-type=""data-identifier="true">产品入库单号</th>
                        <th data-column-id="productName"data-identifier="true">产品名称</th>
                        <th data-column-id="productCategory" data-order=""data-identifier="true">产品类别</th>
                        <th data-column-id="productStorageQuantity" data-order=""data-identifier="true">产品入库数量</th>
                        <th data-column-id="storageStaff" data-order=""data-identifier="true">仓储员工</th>
                        <th data-column-id="productStorageStatus" data-order=""data-identifier="true">产品入库状态</th>
                        <th data-column-id="productStorageDate" data-order=""data-identifier="true">产品入库日期</th>
                        <%--<th data-column-id="commands" data-formatter="commands" data-sortable="false"data-identifier="true"data-row-id="commands">操作权限</th>--%>
                    </tr>
                    </thead>
                    <tbody>
                    <c:forEach items="${ProductWarehousingList}" var="userList">
                        <tr>
                            <td><input  type="checkbox" name="id[]"
                                        value="${userList.productStorageOrdersNo}"/>${userList.productStorageOrdersNo}</td>
                            <td>${userList.productName}</td>
                            <td>${userList.productCategory}</td>
                            <td>${userList.productStorageQuantity}</td>
                            <td>${userList.storageStaff}</td>
                            <td>${userList.productStorageStatus}</td>
                            <td><fmt:formatDate value="${userList.productStorageDate}"
                ...
                <div class="text-center">
                    <div class="card pt-inner">
                        <div class="pti-header bgm-bluegray">
                            <h2>产品入库单修改</h2><small>| safe</small>
                ...
                <form id="add" class="form-horizontal">
                    <div class="form-group">
                        <nobr><label for="add" class="col-sm-2 control-label"><i style="font-size:xx-large"class="zmdi zmdi-assignment zmdi-hc-fw"></i></label>
                            <div class="col-sm-6">
                                <input type="hidden" id="productStorageOrdersNo" name="productStorageOrdersNo" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input style="font-size:x-large" type="name" name="productName" class="form-control" id="productName" placeholder="请输入产品名称">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input style="font-size:x-large" type="value" name="productCategory" class="form-control" id="productCategory" placeholder="请输入产品类别">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input style="font-size:x-large" type="" name="productStorageQuantity" class="form-control" id="productStorageQuantity" placeholder="请输入产品入库数量">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input style="font-size:x-large" type="value" name="productStorageDate" class="form-control" id="productStorageDate" placeholder="产品入库日期">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input style="font-size:x-large" type="" id="productStorageStatus"name="productStorageStatus" class="form-control" placeholder="请输产品入库状态">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="text-center">
                    <div class="card pt-inner">
                        <div class="pti-header bgm-bluegray">
                            <h2>产品入库单增加</h2><small>| safe</small>
                            <div class="ptih-title">Banana Pack</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-body">
                <form id="" class="form-horizontal">
                    <div class="form-group">
                        <nobr><label for="add" class="col-sm-2 control-label"><i style="font-size:xx-large"class="zmdi zmdi-assignment zmdi-hc-fw"></i></label>
                            <div class="col-sm-6">
                                <input type="name"  name="productStorageOrdersNo" placeholder="请输入产品单编号"  style="font-size:x-large"class="form-control">
                                <span class="help-block"></span>
                            </div>
                        </nobr>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="add" class="col-sm-2 control-label"><i style="font-size:xx-large"class="zmdi zmdi-dialpad zmdi-hc-fw"></i></label>
                        <div class="col-sm-6">
                            <input style="font-size:x-large" type="value" name="productCategory" class="form-control" placeholder="请输入产品类别">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="add" class="col-sm-2 control-label"><i style="font-size:xx-large"class="zmdi zmdi-collection-item-1 zmdi-hc-fw"></i></label>
                        <div class="col-sm-8">
                            <input style="font-size:x-large" type="" name="productStorageQuantity" class="form-control"  placeholder="请输入产品入库数量">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="add" class="col-sm-2 control-label"><i style="font-size:xx-large"class="zmdi zmdi-time zmdi-hc-fw"></i></label>
                        <div class="col-sm-6">
                            <input style="font-size:x-large" type="date" name="productStorageDate" class="form-control" placeholder="产品入库日期">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="add" class="col-sm-2 control-label"><i style="font-size:xx-large"class="zmdi zmdi-redo zmdi-hc-fw"></i></label>
                        <div class="col-sm-8">
                            <input style="font-size:x-large" type="" name="productStorageStatus" class="form-control" placeholder="请输产品入库状态">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
...
//              });
    ...
    // }
    <!--删除单项-->
    function  productWarehousing_del(){
        var id=document.getElementById("masthead-label-2").value
        var r = confirm("是否确认删除？");
        if(r==true){
            $.get("/productWarehousingController/productWarehousingDelete.do?productStorageOrdersNo="+id,function(data){
                if(data=="ok"){
                    alert("删除失败！");
                }else{
                    alert("删除成功！");
    ...
    $('#update_button').click(function () {
        //1、判断员工的正则表示
        $.ajax({
            url:'<%=basePath%>/productWarehousingController/saveProductWarehousing.do',
            type:"POST",
    ...
    function useAjaxUpdate() {
        ...
        $.ajax({
            url:'<%=basePath%>/productWarehousingController/getProductWarehousing.do',
            type: 'POST',
            dataType: "JSON",
            ...
            success:function (json){
                ...
                $('#productStorageOrdersNo').val(ptmData.productStorageOrdersNo);
                $('#productName').val(ptmData.productName);
                $('#storageStaff').val(ptmData.storageStaff);
                $('#productCategory').val(ptmData.productCategory);
                $('#productStorageQuantity').val(ptmData.productStorageQuantity);
                $('#productStorageDate').val(ptmData.productStorageDate);
                $('#productStorageStatus').val(ptmData.productStorageStatus);
            }
        });
        $('#myUpdateModal').modal({
            backdrop : 'static'
    ...
    $('#update_button2').click(function () {
        $.ajax({
            url:'<%=basePath%>/productWarehousingController/addProductWarehousing.do',
            type:"POST",

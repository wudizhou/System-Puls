            ...
            <div class="text-center">
                <div class="card pt-inner">
                    <div class="pti-header bgm-blue">
                        <h2>客户信息修改<small>| safe</small></h2>
                        <div class="ptih-title">Banana Pack</div>
                    </div>

                    <form action="<%=basePath%>/customerController/customerUpdate.do" method="post" class="definewidth m20">
                        <input type="hidden" name="customer" value="${customer.customerManagementNo}">

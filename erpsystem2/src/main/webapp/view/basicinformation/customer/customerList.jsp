        ...
        <div class="container">
            ...
            <div class="card">
                ...
                <table id="data-table-command" class="table table-striped table-vmiddle">
                    <thead>
                    <tr>
                        <th data-column-id="customerManagementNo" data-type=""data-identifier="true">客户管理单编号</th>
                        <th data-column-id="customerAbbreviation"data-identifier="true">客户名称</th>
                        <th data-column-id="customerTel" data-order=""data-identifier="true">电话</th>
                        <th data-column-id="customerLinkman" data-order=""data-identifier="true">联系人</th>
                        <th data-column-id="customerEmail" data-order=""data-identifier="true">邮箱</th>
                        <th data-column-id="customerDepositBank" data-order="desc"data-identifier="true">开户银行</th>
                        <%--<th data-column-id="commands" data-formatter="commands" data-sortable="false"data-identifier="true"data-row-id="commands">操作权限</th>--%>
                    </tr>
                    </thead>
                    <tbody>
                    <c:forEach items="${customerList}" var="userList">
                        <tr>
                            <td><input  type="checkbox" name="id[]"
                                        value="${userList.customerManagementNo}" />${userList.customerManagementNo}</td>
                            <td>${userList.customerAbbreviation}</td>
                            <td>${userList.customerTel}</td>
                            <td>${userList.customerLinkman}</td>
                            <td>${userList.customerEmail}</td>
                            <td>${userList.customerDepositBank}</td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>

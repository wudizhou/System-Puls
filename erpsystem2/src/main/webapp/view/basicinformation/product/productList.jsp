                ...
                <ul class="actions">
                    ...
                    <li class="dropdown">
                       ...
                       <li class="dropdown">
                           ...
                           <ul class="dropdown-menu dm-icon pull-right">
                           <div class="text-c">
                               <form action="/productController/selectProduct.do" class="form form-horizontal"method="post">
                                   <nobr><select class="select-box inline" style="width:100px" name="type" size="1">
                                       <option value="keyWords">关键字段：</option>
                                       <option value="productManagementNo">产品管理编号</option>
                                       <option value="productName">产品名称</option>
                                       <option value="productOriginAddress">产地</option>
                                       <option value="productUnit">单位</option>
                                       <option value="productSpecification">规格</option>
                                       <option value="productBatchNumber">批号</option>
                                   </select>&nbsp;
                        ...
                        <c:forEach items="${productList}" var="product"  >
                            <tr>
                                <td><input  type="checkbox" name="id[]"
                                            value="${product.productManagementNo}" />${product.productManagementNo}</td>
                                <td>${product. productName }</td>
                                <td>${product.productOriginAddress }</td>
                                <td>${product.productUnit }</td>
                                <td>${product.productSpecification }</td>
                                <td>${product.productBatchNumber }</td>
                                <td>
                                    <a onclick="openUpdateProduct(this,'${product.productManagementNo}')" href="javascript: ;"><button class="btn btn-default btn-icon-text"><i class="zmdi zmdi-edit"></i>修改</button></a>
                                    <a href="javascript: ;" onclick="productManagementNo_del(this,'${product.productManagementNo}')"><button class="btn btn-default btn-icon-text"><i class="zmdi zmdi-delete"></i> 删除 </button></a>
                                </td>
                    ...
                    <table class="table table-bordered table-hover m10">
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    ...
                                    <div class="fg-line">
                                        <input type="text" class="form-control" id="product" name="product" value="${product.productManagementNo}" placeholder="产品管理单编号">
                                    </div>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    ...
                                    <div class="fg-line">
                                        <input type="text" class="form-control"id="productOriginAddress" name="productOriginAddress" value="${product.productOriginAddress}" placeholder="产地">
                                    </div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    ...
                                    <div class="fg-line">
                                        <input type="text" class="form-control" id="productUnit" name="productUnit" value="${product.productUnit}" placeholder="单位">
                                    </div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    ...
                                    <div class="fg-line">
                                        <input type="text" class="form-control" id="productSpecification" name="productSpecification" value="${product.productSpecification}" placeholder="规格">
                                    </div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    ...
                                    <div class="fg-line">
                                        <input type="text" class="form-control" id="productBatchNumber" name="productBatchNumber" value="${product.productBatchNumber}" placeholder="批号">
                                    </div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <div class="fg-line">
                                        <button onclick="savaProduct()" class="btn btn-default btn-icon-text"><i class="zmdi zmdi-check-all"></i>保存</button>
...
<script>
    <!--删除单项-->
    function productManagementNo_del(obj,s_id){
        var r = confirm("是否确认删除？");
        if(r==true){
            var id = s_id;
            $.get("/productController/productDelete.do?productManagementNo="+id,function(data){
                if(data=="ok"){
                    alert("删除失败！");
                }else{
                    alert("删除成功！");
    ...
    function InsertProduct() {
        ...
        $("#title").text("商品信息增加");
        //设置表单的action（重点）
        $("#form").prop("action", "/productController/addProduct.do");
        //弹出模态框
        $("#myModal").modal("show");
    }
    //修改
    ...
    function savaProduct() {
        //获取页面信息
        var productManagementNo = $("#form [name='product']").val();
        var productName = $("#form [name='productName']").val();
        var productOriginAddress= $("#form [name='productOriginAddress']").val();
        var productSpecification = $("#form [name='productSpecification']").val();
        var productUnit = $("#form [name='productUnit']").val();
        var productBatchNumber = $("#form [name='productBatchNumber']").val();
        //判断内容不等于空
        if(productManagementNo != "" && productName != ""&& productOriginAddress != ""&& productSpecification != ""&& productUnit != ""&& productBatchNumber != "") {
            //提交表单
            $("#form").ajaxSubmit(function(returnJson) {

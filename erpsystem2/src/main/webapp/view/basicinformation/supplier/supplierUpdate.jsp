            ...
            <div class="text-center">
                <div class="card pt-inner">
                    <div class="pti-header bgm-blue">
                        <h2>供应商信息修改<small>| safe</small></h2>
                        <div class="ptih-title">Banana Pack</div>
                    </div>

                    <form action="<%=basePath%>/supplierController/supplierUpdate.do" method="post" class="definewidth m20">
                        <input type="hidden" name="supplier" value="${supplier.supplierManagementNo}">
                            ...
                            <div class="pti-body">
                                <tr>
                                    <td>
                                        ...
                                        <div class="ptib-item">
                                            <span class="input-group-addon"><i class="zmdi zmdi-pin-account zmdi-hc-fw"></i></span><input type="text" class="form-control" name="supplierAbbreviation" value="${supplier.supplierAbbreviation}" placeholder="客户简称">
                                        </div>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="ptib-item">
                                            <span class="input-group-addon"><i class="zmdi zmdi-phone"></i></span><input type="text" class="form-control" name="supplierTel" value="${supplier.supplierTel}" placeholder="电话">
                                        </div>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="ptib-item">
                                            <span class="input-group-addon"><i class="zmdi zmdi-account zmdi-hc-fw"></i></span><input type="text" class="form-control" name="supplierLinkman" value="${supplier.supplierLinkman}" placeholder="联系人">
                                        </div>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="ptib-item">
                                            <span class="input-group-addon"><i class="zmdi zmdi-email"></i></span><input type="text" class="form-control" name="supplierEmail" value="${supplier.supplierEmail}" placeholder="邮箱">
                                        </div>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="ptib-item">
                                            <span class="input-group-addon"><i class="zmdi zmdi-balance zmdi-hc-fw "></i></span><input type="text" class="form-control" name="supplierDepositBank" value="${supplier.supplierDepositBank}" placeholder="开户银行">
                                        </div>

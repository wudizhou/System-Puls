        ...
        <div class="container">
            ...
            <div class="card">
                ...
                <table id="data-table-command" class="table table-striped table-vmiddle">
                    <thead>
                    <tr>
                        <th data-column-id="supplierManagementNo" data-type=""data-identifier="true">销售单编号</th>
                        <th data-column-id="supplierAbbreviation"data-identifier="true">产品名称</th>
                        <th data-column-id="supplierTel" data-order=""data-identifier="true">客户名称</th>
                        <th data-column-id="supplierLinkman" data-order=""data-identifier="true">销售数量</th>
                        <th data-column-id="supplierEmail" data-order=""data-identifier="true">销售日期</th>
                        <th data-column-id="supplierDepositBank" data-order="desc"data-identifier="true">销售状态</th>

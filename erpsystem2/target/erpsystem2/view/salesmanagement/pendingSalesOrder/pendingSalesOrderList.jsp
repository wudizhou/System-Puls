        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <ul class="actions">
                        <li>
                            <a href="<%=basePath%>/pendingSalesOrderController/pendingSalesOrderListPhy2.do"><i class="zmdi zmdi-refresh"></i></a>
                        </li>
                    </ul>
                </div>
                ...
                <table id="data-table-command" class="table table-striped table-vmiddle">
                    <thead>
                    <tr>
                        <th data-column-id="staySalesOrderNo" data-type=""data-identifier="true">待销售单编号</th>
                        ...
                        <th data-column-id="salesQuantity" data-order=""data-identifier="true">销售数量</th>
                        <%--<th data-column-id="commands" data-formatter="commands" data-sortable="false"data-identifier="true"data-row-id="commands">操作权限</th>--%>
                    </tr>
                    </thead>
                    <tbody>
                    <c:forEach items="${pendingSalesOrderList}" var="pendingSalesOrder">
                        <tr>
                            <td><input  type="checkbox" name="id[]"
                                        value="${pendingSalesOrder.staySalesOrderNo}" />${pendingSalesOrder.staySalesOrderNo}</td>
                            <td>${pendingSalesOrder.productName}</td>
                            <td>${pendingSalesOrder.customerName}</td>
                            <td>${pendingSalesOrder.salesQuantity}</td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>

                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            <form class="tsw-inner" action="<%=basePath%>commodityController/selectCommodity.do" method="post">
                                <input type="text" name="keyword" class="abc input-default" placeholder="请输入单号或产地关键字" value="">
                            </form>
                            <%--<li>--%>
                            <%--<a href="">删除</a>--%>
                            <%--</li>--%>
            ...
            <div class="modal-body">
                <form id="add" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input style="font-size:x-large" type="" name="salesDate" class="form-control" id="update_date" placeholder="请输入销售日期">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
    ...
    function getSob(s) {
        $.ajax({
            url:"<%=basePath%>/salesOrderBrowseController/getSalesOrder/"+s,
            type:"GET",
            dataType:"json",

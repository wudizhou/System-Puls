    ...
    <aside id="sidebar" class="sidebar c-overflow">
        ...
        <ul class="main-menu">
            ...
            <li class="sub-menu">
                ...
                <ul>
                    <li>
                        <a href="textual-menu.html">Textual menu</a>
                    </li>
                    <li>
                        <a href="image-logo.html">Image logo</a>
                    </li>
                    <li>
                        <a href="top-mainmenu.html">Mainmenu on top</a>
                    </li>
                </ul>
            </li>
            <li>
                <a href="typography.html"><i class="zmdi zmdi-format-underlined"></i> Typography</a>
            </li>
            <li class="sub-menu">
                ...
                <ul>
                    <li>
                        <a href="widget-templates.html">Templates</a>
                    </li>
                    <li>
            ...
            <li class="sub-menu">
                ...
                <ul>
                    ...
                    <li>
                        <a href="notification-dialog.html">Notifications & Dialogs</a>
                    </li>
                    <li>
            ...
            <li>
                <a href="calendar.html"><i class="zmdi zmdi-calendar"></i> Calendar</a>
            </li>
            <li class="sub-menu">
            ...
            <li>
                <a href="generic-classes.html"><i class="zmdi zmdi-layers"></i> Generic Classes</a>
            </li>
            <li class="sub-menu active toggled">
                ...
                <ul>
                    ...
                    <li>
                        <a class="active" href="pricing-table.html">Pricing Table</a>
                    </li>
                    <li>
            ...
            <div class="text-center">
                <div class="card pt-inner">
                    <div class="pti-header bgm-blue">
                        <h2>客户信息增加<small>| safe</small></h2>
                        <div class="ptih-title">Banana Pack</div>
                    </div>

                    <form action="<%=basePath%>/customerController/addCustomer.do" method="post" class="definewidth m20">
                            ...
                            <div class="pti-body">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="ptib-item">
                                                <span class="input-group-addon"><i class="zmdi zmdi-collection-text zmdi-hc-fw"></i></span><input type="text" class="form-control" name="customer" value="${customer.customerManagementNo}" placeholder="客户管理单编号">
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="ptib-item">
                                            <span class="input-group-addon"><i class="zmdi zmdi-pin-account zmdi-hc-fw"></i></span><input type="text" class="form-control" name="customerAbbreviation" value="${customer.customerAbbreviation}" placeholder="客户简称">
                                        </div>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="ptib-item">
                                            <span class="input-group-addon"><i class="zmdi zmdi-phone"></i></span><input type="text" class="form-control" name="customerTel" value="${customer.customerTel}" placeholder="电话">
                                        </div>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="ptib-item">
                                            <span class="input-group-addon"><i class="zmdi zmdi-account zmdi-hc-fw"></i></span><input type="text" class="form-control" name="customerLinkman" value="${customer.customerLinkman}" placeholder="联系人">
                                        </div>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="ptib-item">
                                            <span class="input-group-addon"><i class="zmdi zmdi-email"></i></span><input type="text" class="form-control" name="customerEmail" value="${customer.customerEmail}" placeholder="邮箱">
                                        </div>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="ptib-item">
                                            <span class="input-group-addon"><i class="zmdi zmdi-balance zmdi-hc-fw "></i></span><input type="text" class="form-control" name="customerDepositBank" value="${customer.customerDepositBank}" placeholder="开户银行">
                                        </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="pti-footer">
                                            <%--<a href="<%=basePath%>/customerController/customerToUpdatePage.do" method="post" class="bgm-blue"><i class="zmdi zmdi-check"></i></a>--%>
                                            <button class="btn bgm-blue btn-icon"><i style="font-size: xx-large" class="zmdi zmdi-check"></i></button>
                                        </div>
                                    </td>
                                </tr>

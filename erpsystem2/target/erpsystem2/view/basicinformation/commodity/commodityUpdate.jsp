        ...
        <div class="container">
            ...
            <div class="card">
                ...
                <div class="card-body card-padding">
                    ...
                    <form action="<%=basePath%>/commodityController/commodityUpdate.do" method="post" class="definewidth m20">
                        <input type="hidden" name="commodity"   value="${commodity.commodityManagementNo}">
                        <table class="table table-bordered table-hover m10">
                            ...
                            <tr>
                                ...
                                <td><div class="input-group">
                                    ...
                                    <div class="fg-line">
                                        <input type="text" class="form-control" name="commodityName" value="${commodity.commodityName}"placeholder="商品名称">
                                    </div>
                                </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td> <div class="input-group">
                                    ...
                                    <div class="fg-line">
                                        <input type="text" class="form-control" name="commodityOriginAddress" value="${commodity.commodityOriginAddress}"placeholder="产地">
                                    </div>
                                </div></td>
                            </tr>
                            <tr>
                                ...
                                <td><div class="input-group">
                                    ...
                                    <div class="fg-line">
                                        <input type="text" class="form-control" name="commodityUnit" value="${commodity.commodityUnit}"placeholder="单位">
                                    </div>
                                </div></td>
                            </tr>
                            <tr>
                                ...
                                <td><div class="input-group">
                                    ...
                                    <div class="fg-line">
                                        <input type="text" class="form-control" name="commoditySpecification" value="${commodity.commoditySpecification}"placeholder="规格">
                                    </div>
                                </div></td>
                            </tr>
                            <tr>
                                ...
                                <td><div class="input-group">
                                    ...
                                    <div class="fg-line">
                                        <input type="text" class="form-control" name="commodityBatchNumber" value="${commodity.commodityBatchNumber}"placeholder="批号">
                                    </div>
                                </div>
                                </td>
                            </tr>

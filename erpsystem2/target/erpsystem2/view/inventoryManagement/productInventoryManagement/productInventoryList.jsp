        ...
        <div class="container">
                ...
                <ul class="actions">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dm-icon pull-right">
                            ...
                            <br/>
                            <li>
                                <nobr>&nbsp;&nbsp;<input type="text" name="" id="masthead-label-2"class="abc input-default" placeholder="请输入领料出库单编号" value="">&nbsp;<button style="height:26px; width:26px" onClick="pickingOutboundDeliveryOrderNo_del()" class="btn btn-default btn-icon"><i style="font-size:x-large" class="zmdi zmdi-delete"></i></button></nobr>
                            </li>
            ...
            <div class="card">
                ...
                <table id="data-table-command" class="table table-striped table-vmiddle">
                    <thead>
                    <tr>
                        <th data-column-id="productInventoryNo" data-type=""data-identifier="true">产品库存单编号</th>
                        <th data-column-id="productName"data-identifier="true">产品名称</th>
                        <th data-column-id="productPrice" data-order=""data-identifier="true">产品单价</th>
                        <th data-column-id="productInventoryQuantity" data-order=""data-identifier="true">产品库存数量</th>
                    ...
                    <tbody>
                    <c:forEach items="${ProductInventoryList}" var="userList">
                        <tr>
                            <td><input  type="checkbox" name="id[]"
                                        value="${userList.productInventoryNo}" />${userList.productInventoryNo}</td>
                            <td>${userList.productName}</td>
                            <td>${userList.productPrice}</td>
                            <td>${userList.productInventoryQuantity}</td>
                ...
                <div class="text-center">
                    <div class="card pt-inner">
                        <div class="pti-header bgm-bluegray">
                            <h2>产品库存单修改</h2><small>| safe</small>
                ...
                <form id="add" class="form-horizontal">
                    <div class="form-group">
                        <nobr><label for="add" class="col-sm-2 control-label"><i style="font-size:xx-large"class="zmdi zmdi-assignment zmdi-hc-fw"></i></label>
                            <div class="col-sm-6">
                                <input type="hidden" id="productInventoryNo" name="productInventoryNo" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input style="font-size:x-large" type="name" name="productPrice" class="form-control" id="productPrice" placeholder="请输入产品单价">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input style="font-size:x-large" type="" name="productInventoryQuantity" class="form-control" id="productInventoryQuantity" placeholder="请输入产品库存数量">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="text-center">
                    <div class="card pt-inner">
                        <div class="pti-header bgm-bluegray">
                            <h2>产品库存单增加</h2><small>| safe</small>
                            <div class="ptih-title">Banana Pack</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-body">
                <form id="" class="form-horizontal">
                    <div class="form-group">
                        <nobr><label for="add" class="col-sm-2 control-label"><i style="font-size:xx-large"class="zmdi zmdi-assignment zmdi-hc-fw"></i></label>
                            <div class="col-sm-6">
                                <input type="name"  style="font-size:x-large" name="productInventoryNo" class="form-control"placeholder="请输入产品库存单号">
                                <span class="help-block"></span>
                            </div>
                        </nobr>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="add" class="col-sm-2 control-label"><i style="font-size:xx-large"class="zmdi zmdi-shopping-cart zmdi-hc-fw"></i></label>
                        <div class="col-sm-6">
                            <input style="font-size:x-large" type="name" name="productPrice" class="form-control"  placeholder="请输入产品单价">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="add" class="col-sm-2 control-label"><i style="font-size:xx-large"class="zmdi zmdi-collection-item-1 zmdi-hc-fw"></i></label>
                        <div class="col-sm-8">
                            <input style="font-size:x-large" type="" name="productInventoryQuantity" class="form-control"  placeholder="请输入产品库存数量">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
...
//              });
    ...
    // }
    <!--删除单项-->
    function pickingOutboundDeliveryOrderNo_del(){
        var id=document.getElementById("masthead-label-2").value
        var r = confirm("是否确认删除？");
        if(r==true){
            $.get("/productInventoryController/productInventoryDelete.do?productInventoryNo="+id,function(data){
                if(data=="ok"){
                    alert("删除失败！");
                }else{
                    alert("删除成功！");
    ...
    $('#update_button').click(function () {
        //1、判断员工的正则表示
        $.ajax({
            url:'<%=basePath%>/productInventoryController/saveProductInventory.do',
            type:"POST",
    ...
    function useAjaxUpdate() {
        ...
        $.ajax({
            url:'<%=basePath%>/productInventoryController/getProductInventory.do',
            type: 'POST',
            dataType: "JSON",
            ...
            success:function (json){
                ...
                //  console.log(data);
                //得到emp的值
                var pimData = json.pim;
                // var dateOfSob = new Date(sobData.salesDate);
                $('#productInventoryNo').val(pimData.productInventoryNo);
                $('#productName').val(pimData.productName);
                $('#productPrice').val(pimData.productPrice);
                $('#productCategory').val(pimData.productCategory);
                $('#productInventoryQuantity').val(pimData.productInventoryQuantity);
            }
        });
        $('#myUpdateModal').modal({
            backdrop : 'static'
    ...
    $('#update_button2').click(function () {
        $.ajax({
            url:'<%=basePath%>/productInventoryController/addProductInventory.do',
            type:"POST",

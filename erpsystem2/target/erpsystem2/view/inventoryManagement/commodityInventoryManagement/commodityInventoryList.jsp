                            ...
                            <tr align="center">
                                <td colspan="12"><div class="pagelist" style="padding-left: 39%;">
                                    第${pb.pc }页/共${pb.tp }页 <a
                                        href="<c:url value='/commodityInventoryController/commodityInventoryList.do?pc=1'/>">首页</a>
                                    <c:if test="${pb.pc>1 }">
                                        <a href="<c:url value='/commodityInventoryController/commodityInventoryList.do?pc=${pb.pc-1 }'/>">上一页</a>
                                    </c:if>
                                    <%-- （2）计算：begin、end --%>
                                    <c:choose>
                                        ...
                                        <c:choose>
                                            <c:when test="${i eq pb.pc}">
                                                <a style="color: green; font-weight: bold; font-size: 16px;"
                                                   href="<c:url value='/commodityInventoryController/commodityInventoryList.do?pc=${i }'/>">${i }</a>
                                            </c:when>
                                            <c:otherwise>
                                                <a href="<c:url value='/commodityInventoryController/commodityInventoryList.do?pc=${i }'/>">${i }</a>
                                            </c:otherwise>
                                        </c:choose>
                                    </c:forEach>
                                    ...
                                    <c:if test="${pb.pc<pb.tp }">
                                        <a href="<c:url value='/commodityInventoryController/commodityInventoryList.do?pc=${pb.pc+1 }'/>">下一页</a>
                                    </c:if>

                                    <a href="<c:url value='/commodityInventoryController/commodityInventoryList.do?pc=${pb.tp }'/>">尾页</a>
